...
transform judul:
    align(0.1, 0.1)
style judul_label_text:
    font "fonts/Bangers-Regular.ttf"
    size 80

style judul_button_text:
    font "fonts/Bangers-Regular.ttf"
    size 64
...
screen input(prompt):
    ...
    frame:
        background Frame("gui/input_frame_bg.webp",Borders(25,25,25,25))
        xalign 0.5
        yalign 0.2
        xpadding 30
        ypadding 30
    ...
    if renpy.get_screen("main_menu"):
        ...
        vbox:
            ...
            if main_menu:
                ...
                textbutton _("Exit") action Quit(confirm= main_menu)
        ...
        grid 3 3:
            ...
            for i in range(6):
                ...
                button:
                    ...
                    #tombol untuk menyimpan saveload    
    ...
    vbox:
        ...
        hbox:
            ...
            imagebutton auto "gui/button/back_%s.png":
                yalign 0.5
                action FilePagePrevious(max=2, wrap=True, auto=False, quick=False)

            imagebutton auto "gui/button/btnback_%s.png":

                action Return()

            imagebutton auto "gui/button/next_%s.png":
                yalign 0.5
                action FilePageNext(max=2, wrap=True, auto=False, quick=False)
                    ...
                    hbox:
                        ...
                        vbox:
                            ...
                            vbox:
                                ...
                                imagebutton:
                                    xpos 100
                                    idle "gui/button/togleunactive.png"
                                    hover "gui/button/togleunactive.png"
                                    selected_idle "gui/phone/button/togleactive.png"
                                    selected_hover "gui/phone/button/togleactive.png"
                                    action Preference("after choices", "toggle")
                                imagebutton:
                                    xpos 100
                                    idle "gui/phone/button/togleunactive.png"
                                    hover "gui/phone/button/togleunactive.png"
                                    selected_idle "gui/phone/button/togleactive.png"
                                    selected_hover "gui/phone/button/togleactive.png"
